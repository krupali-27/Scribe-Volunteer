...
if(isset($_POST['firstname']))
{
    ...
    $e = array();
    $sql1 = mysqli_query($conn,"SELECT *FROM handicap1 WHERE 'emailid'='". $_POST['emailid'] . "'");
    ...
    {
      $sql = "INSERT INTO `handicap1`( `Fname`, `Lname`, `emailid`, `contactno`, `dob`, `gender`, `pass`) 
      VALUES ('$fname','$lname','$email','$contactno','$dob','$gender','$pass')";  
        ...
        {
          header("location: registration(h).php");
        }
    }
...
include_once('header.html');?>
    ...
    <div class="col-lg-14">
        <div class="bg-primary rounded h-100 d-flex align-items-center p-5 wow zoomIn" data-wow-delay="0.9s">        
            <form action="registration(h).php" id="form" method="post" >
